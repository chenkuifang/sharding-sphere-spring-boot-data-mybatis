...
CREATE TABLE `t_order_0` (
  `order_id` VARCHAR (20) NOT NULL COMMENT '订单编码',
...
DROP TABLE IF EXISTS `t_order_detail0`;
CREATE TABLE `t_order_detail0` (
  `detail_id` bigint(20) NOT NULL AUTO_INCREMENT COMMENT '订单明细编码',
  `order_id` bigint(20) NOT NULL AUTO_INCREMENT COMMENT '订单编码',
  `goods_id` bigint(20) NOT NULL AUTO_INCREMENT COMMENT '商品编码',
...
) ENGINE=InnoDB AUTO_INCREMENT=224215976852324353 DEFAULT CHARSET=utf8 COMMENT='订单明细信息表';

DROP TABLE IF EXISTS `t_order_detail1`;
CREATE TABLE `t_order_detail1` (
  `detail_id` bigint(20) NOT NULL AUTO_INCREMENT COMMENT '订单明细编码',
  `order_id` bigint(20) NOT NULL AUTO_INCREMENT COMMENT '订单编码',
  `goods_id` bigint(20) NOT NULL AUTO_INCREMENT COMMENT '商品编码',
  `price` decimal(20,2) DEFAULT '0.00' COMMENT '商品价格',
